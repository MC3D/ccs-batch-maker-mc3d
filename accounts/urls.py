...
urlpatterns = [
    ...
    path('connections/', views.ConnectionListCreateAPIView.as_view(), name='connection_list_api'),
    path('<int:pk>/connections/', views.ConnectionListCreateAPIView.as_view(), name='connection_create_api'),
